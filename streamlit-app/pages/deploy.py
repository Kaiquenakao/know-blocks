...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col_right:
        ...
        model = st.selectbox(
            "Default model",
            ["nomic-embed-text", "all-minilm", "amazon.titan-embed-text-v2"],
            format_func=lambda m: {
                "nomic-embed-text": "nomic-embed-text — 768 dims · Ollama · free",
                "all-minilm": "all-minilm — 384 dims · Ollama · free",
                "amazon.titan-embed-text-v2": "Titan Embed V2 — 1024 dims · Bedrock · $0.02/1M",
            }[m],
        )
        ...
        info = {
            ...
            "amazon.titan-embed-text-v2": (
                ...
                "$0.02 / 1M tokens",
                "bedrock",
                "AWS Bedrock — best for search queries, no infra needed",
            ),
        }
